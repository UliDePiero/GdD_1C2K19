...
namespace FrbaCrucero.BD_y_Querys
{
    public static class Tramo_BD
    {
        ...
        {
            string query = string.Format(@"SELECT tram_id as ID, tram_precio as Precio, tram_duracion as Duracion, tram_origen as Puerto_origen, tram_destino as Puerto_destino
